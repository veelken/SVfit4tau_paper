...
In order to maximise the sensitivity of searches for such resonances, 
it is important that experimental analyses cover a variety of decay modes of the $\PHiggs$ boson pair.
...
The algorithm achieves a relative resolution on the mass of the $\PHiggs$ boson pair of $3$--$8\%$.
%An algorithm for the reconstruction of the mass of Higgs boson pairs in events with Higgs boson pairs 
%decaying into four $\Pgt$ leptons is presented.
%The algorithm achieves a relative resolution on the mass of the Higgs boson pair of $3$--$8\%$.
%We expect the algorithm to be useful in searches for new resonances decaying to Higgs boson pairs.
\end{abstract}
